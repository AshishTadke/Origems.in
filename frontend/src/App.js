      ...
      <section id="contact" className="py-24 px-6 bg-gray-900" data-testid="contact-section">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="text-center mt-8 animate-fade-in-up">
            <p className="text-gray-400 mb-4">Or message us directly</p>
            <a 
              href="https://wa.me/918983609962" 
              target="_blank" 
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 px-8 py-4 bg-green-600 hover:bg-green-700 text-white rounded-full text-lg font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-green-600/50"
